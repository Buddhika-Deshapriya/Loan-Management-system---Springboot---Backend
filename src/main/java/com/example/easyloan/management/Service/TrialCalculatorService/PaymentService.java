package com.example.easyloan.management.Service.TrialCalculatorService;
...
public class PaymentService {
     ...
     * calculates the mortgage or annuity payment/yield per period.
     *
     ...
     * <p/>
     * The 'fv' defaults to 0, showing 'intent to finish annuity'. See
     * http://www.excelfunctions.net/Excel-Nper-Function.html
     *
     * @return double
     * @see #pmt(double, int, double, double, int)
     */
     ...
     * which calculates the portion of the payment at a given period that is the
     ...
     * which calculates the portion of the payment at a given period that will apply
     * to principal.
     *
     * @param r    periodic interest rate represented as a decimal.
     * @param per  period (payment number) to check value at.
